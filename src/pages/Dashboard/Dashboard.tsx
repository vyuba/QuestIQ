  ...
  return (
    <div>
      <div className="w-full h-full flex flex-row ">
        ...
        >
          <div className="flex flex-row w-fit h-[calc(100dvh-6rem)] md:h-[calc(100%-20px)] bg-secondary-color mb-2  border-2 border-border-color rounded-xl  overflow-hidden gap-2 p-2">
